...
func init() {
	...
	Router.HandleFunc("/mod/torrents/deleted", WrapModHandler(TorrentsListPanel)).Name("mod_tlist_deleted").Methods("GET")
	Router.HandleFunc("/mod/torrents/deleted/{page:[0-9]+}", WrapModHandler(TorrentsListPanel)).Name("mod_tlist_deleted_page").Methods("GET")
